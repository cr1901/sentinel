...
source code. If neither of those apply, you can download the Verilog of the
lastest release of Sentinel {{ '[here](https://github.com/cr1901/sentinel/releases/download/{ver}/sentinel-v-{ver}.zip)'.format(ver=sent_latest_tag) }}. See {ref}`pre-generated` for more information.
```
