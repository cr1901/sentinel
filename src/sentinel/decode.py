...
class Decode(Component):
    ...
    csr_encoding: Out(4)
        :attr:`Compressed CSR encoding` generated by
        :class:`~sentinel.control.MappingROM`. Valid on the first active edge
        after :attr:`do_decode` asserts *if* the current instruction is a
        CSR instruction.
